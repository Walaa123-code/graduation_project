...
import 'package:mindecho/core/utils/app_colors.dart'; // مسار موحد للألوان منعاً للتضارب
              ...
              child: _selectedTab == 0
                ...
                builder: (context, state) {
                  ...
                  if (state is BookingErrorState) {
                    return Center(
                      child: Text(state.failure.errors ?? 'Failed to load bookings'),
                    );
                  }
  ...
  Widget build(BuildContext context) {
    return const Center(
      child: Column(
        ...
        children: [
          Icon(Icons.calendar_today_outlined, size: 56, color: AppColors.gray300),
          SizedBox(height: 12),
          Text(
